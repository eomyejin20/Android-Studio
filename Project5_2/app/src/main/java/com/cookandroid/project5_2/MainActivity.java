...
public class MainActivity extends AppCompatActivity {
    ...
    String num1, num2;
    Integer result;
    Button[] numBottons = new Button[10];
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (i = 0; i < numBtnIDs.length; i++) {
            numBottons[i] = (Button) findViewById(numBtnIDs[i]);
        ...
        for (i = 0; i < numBtnIDs.length; i++) {
            ...
            numBottons[index].setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    if (edit1.isFocused() == true) {
                        num1 = edit1.getText().toString()
                                + numBottons[index].getText().toString();
                        edit1.setText(num1);
